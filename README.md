...
# Demo
1. Once the App is deployed, we can access the adminisration panel at http://localhost:5000.
<img width="700" alt="image" src="https://github.com/user-attachments/assets/f79bef25-9070-4526-806c-2112f11e0170" />

2. Click on "Deploy" to set up the K8s cluster with 8 Pods, with 4 of them marked each with malicious label. We can check the deployed Pods using "Get Pods". 
<img width="1049" alt="image" src="https://github.com/user-attachments/assets/6f258c1b-b5a5-4892-a03c-47b79bcfe038" />
...
<img width="1049" alt="image" src="https://github.com/user-attachments/assets/8b27a343-d54a-4778-8841-28f0a9313579" />

3. Click on "Infect" to randomly infect one Pod with malicious label. Once a Pod is infected, it sends pings sent to 1.1.1.1 every minute. We can verify this using "Observe".
<img width="940" alt="image" src="https://github.com/user-attachments/assets/8c63ddb3-10c0-49b0-8a32-0e644362e36c" />

4. To mitigate the malicious C2 communication, we apply the two security intents with "Network Traffic Filtering" and "File Eviction" as D3FEND technique (cf. https://d3fend.mitre.org/) respectively.

4.1. Network Traffic Filtering: With Cilium network policy, all outbound traffic from the infected Pod is blocked.
<img width="937" alt="image" src="https://github.com/user-attachments/assets/25fba898-0b2c-4a88-b4f2-5134ac6287cc" />

4.2. File Eviction: By removing the malicious cron job, no further traffic is generated.
